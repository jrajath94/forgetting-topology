...
\begin{itemize}
  \item The first \textbf{causally-traced} per-component forgetting topology for Qwen3-8B across a four-task sequence, using ROME-style counterfactual intervention.
